...
typedef struct {
	...
	int weapon_str_9[15];
	char unkwn2i[20];
	int weapon_str_10[15];
	char weapon_str_n_1[30];
	char weapon_str_n_2[30];
	char weapon_str_n_3[30];
	char weapon_str_n_4[30];
	char weapon_str_n_5[30];
	char weapon_str_n_6[30];
	char weapon_str_n_7[20];
	int pic_count;
	char pic_bmps[40][10];
	int pic_index[10];
	int pic_width[10];
